...
private:
    ...
    bool* polja;
    int brojPoteza;
    bool kingsideCrniTop,queensideCrniTop,kingsideBeliTop,queensideBeliTop,crniKralj,beliKralj;
    QTimer* tajmer;
    int vreme;
    ...
    void poljaToButtons();
    void priprema();
    bool isFiguraMovable(int);
    QString intToChar(int);
    void proveraPijun(int);
    bool isPoljeNapadnuto(int,QBoja);
    bool isSah(QBoja);
    void narusavaLiRokadu(int);
    bool isRokadaAvailable(int);
    void crtajTopaAkoJeRokada(int,int);
